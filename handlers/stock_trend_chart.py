...
def plot_stock_trend(stock_code):
    ...
    try:
        ...
        ax.plot(df.index, df['MA5'], label="5 日均線", color='orange', linestyle='dashed', linewidth=1)
        ax.plot(df.index, df['MA20'], label="20 日均線", color='red', linestyle='dashed', linewidth=1)
